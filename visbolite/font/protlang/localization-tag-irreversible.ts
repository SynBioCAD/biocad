...
function createGeometry(size) {
    ...
    geom = extend(geom, {
        topLeftSpikeOrigin: geom.left.midPointTo(geom.top).midPointTo(geom.topLeft),
        topRightSpikeOrigin: geom.top.midPointTo(geom.right).midPointTo(geom.topRight),
        bottomRightSpikeOrigin: geom.right.midPointTo(geom.bottom).midPointTo(geom.bottomRight),
        bottomLeftSpikeOrigin: geom.bottom.midPointTo(geom.left).midPointTo(geom.bottomLeft)
    })
...
function renderGlyph(renderOpts) {
    ...
    return svg('g', [
        ...
        svg('path', {
            ...
            'fill': renderOpts.color || renderOpts.defaultColor || 'none'
        }),
